...
--synthesis_resources = 
 ...
 ENTITY  blinker_cmd_xbar_demux_001 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
		 ...
		 src4_data	:	OUT  STD_LOGIC_VECTOR (88 DOWNTO 0);
		 src4_endofpacket	:	OUT  STD_LOGIC;
		 src4_ready	:	IN  STD_LOGIC;
		 src4_startofpacket	:	OUT  STD_LOGIC;
		 src4_valid	:	OUT  STD_LOGIC
	 ); 
 END blinker_cmd_xbar_demux_001;

 ARCHITECTURE RTL OF blinker_cmd_xbar_demux_001 IS
	 ...
	 SIGNAL  s_wire_blinker_cmd_xbar_demux_001_wideor0_11_dataout :	STD_LOGIC;
 ...
 BEGIN
	...
	s_wire_blinker_cmd_xbar_demux_001_wideor0_11_dataout <= ((((wire_w_lg_w_sink_channel_range1w2w(0) OR wire_w_lg_w_sink_channel_range3w4w(0)) OR wire_w_lg_w_sink_channel_range6w7w(0)) OR wire_w_lg_w_sink_channel_range9w10w(0)) OR wire_w_lg_w_sink_channel_range12w13w(0));
	sink_ready <= s_wire_blinker_cmd_xbar_demux_001_wideor0_11_dataout;
	...
	src4_data <= ( sink_data(88 DOWNTO 0));
 ...
 END RTL; --blinker_cmd_xbar_demux_001
