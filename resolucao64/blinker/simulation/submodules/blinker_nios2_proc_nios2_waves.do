add wave -noupdate -divider {blinker_nios2_proc: top-level ports}
...
add wave -noupdate -divider {blinker_nios2_proc: common}
...
add wave -noupdate -divider {blinker_nios2_proc: breaks}
