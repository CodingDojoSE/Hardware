...
--synthesis_resources = 
 ...
 END blinker_addr_router;

 ARCHITECTURE RTL OF blinker_addr_router IS
	 ...
	 SIGNAL  s_wire_blinker_addr_router_src_channel_1_254_dataout :	STD_LOGIC;
 ...
 BEGIN
	...
	wire_w230w(0) <= NOT s_wire_blinker_addr_router_src_channel_1_254_dataout;
	wire_w_lg_w_sink_data_range145w272w(0) <= NOT wire_w_sink_data_range145w(0);
	s_wire_blinker_addr_router_src_channel_1_254_dataout <= (((wire_w_lg_w_sink_data_range142w273w(0) AND (NOT sink_data(49))) AND (NOT sink_data(50))) AND sink_data(51));
	sink_ready <= src_ready;
	src_channel <= ( "0" & "0" & "0" & wire_w230w & s_wire_blinker_addr_router_src_channel_1_254_dataout);
	src_data <= ( sink_data(88 DOWNTO 79) & "0" & wire_w230w & s_wire_blinker_addr_router_src_channel_1_254_dataout & sink_data(75 DOWNTO 0));
