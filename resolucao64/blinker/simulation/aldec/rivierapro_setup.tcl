...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_slave_agent.sv"                                                          -work nios2_proc_jtag_debug_module_translator_avalon_universal_slave_0_agent         
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_burst_uncompressor.sv"                                                   -work nios2_proc_jtag_debug_module_translator_avalon_universal_slave_0_agent         
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_master_agent.sv"                                                         -work nios2_proc_instruction_master_translator_avalon_universal_master_0_agent       
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_slave_translator.sv"                                                     -work nios2_proc_jtag_debug_module_translator                                        
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_master_translator.sv"                                                    -work nios2_proc_instruction_master_translator                                       
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L irq_mapper -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_002 -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L id_router_002 -L id_router -L addr_router_001 -L addr_router -L nios2_proc_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_proc_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_proc_instruction_master_translator_avalon_universal_master_0_agent -L nios2_proc_jtag_debug_module_translator -L nios2_proc_instruction_master_translator -L sysid_1337 -L led -L switcher -L onchip_memory -L nios2_proc -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneiv_hssi -L cycloneiv_pcie_hip -L cycloneiv $TOP_LEVEL_NAME
}
